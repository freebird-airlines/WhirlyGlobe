...
- (nonnull instancetype)initWithBaseURL:(NSString *__nonnull)baseURL minZoom:(int)minZoom maxZoom:(int)maxZoom isTile:(BOOL) isTile tileSize:(int) tileSize imageType:(NSString *) imageType layer:(MaplyWMSLayer *__nonnull)layer style:(MaplyWMSStyle *__nonnull)style parameters:(NSDictionary*_Nullable) parameters headers:(NSDictionary*_Nullable) headers;

/// Base URL
@property (nonatomic,readonly,retain,nonnull) NSString *baseURL;


@property (nonatomic,readonly, assign) BOOL isTile;
