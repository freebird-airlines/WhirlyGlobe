...
- (nonnull instancetype)initWithBaseURL:(NSString *__nonnull)inBaseURL minZoom:(int)inMinZoom maxZoom:(int)inMaxZoom isTile:(BOOL)isTile tileSize:(int)tileSize imageType:(NSString *)imageType layer:(MaplyWMSLayer * _Nonnull)layer style:(MaplyWMSStyle * _Nonnull)style parameters:(NSDictionary * _Nullable)parameters headers:(NSDictionary * _Nullable)headers
{
    self = [super init];
    _baseURL = inBaseURL;
    _minZoom = inMinZoom;
